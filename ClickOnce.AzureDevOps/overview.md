...
| Identity  | Specifies the identity of the application. This is used for the application and deployment manifest file names and the packge folder name. If not specified, a name is inferred from the EntryPoint. |
