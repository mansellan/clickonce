...
namespace ClickOnce
{
    ...
    {
        internal const string ExeFile = @".*\.[eE][xX][eE]$";
        internal const string IconFile = @".*\.[iI][cC][oO]$";
        internal const string HtmlFile = @".*\.[hH][tT][mM][lL]?$";
        ...
        internal const string WindowsVersionNumber = @"^(?:4\.1|4\.9|5\.0|5\.1|5\.2|6\.0|6\.1|6\.2|6\.3|10\.0)(?:\.\d{1,5}(?:\.\d{1,5})?)?$";
